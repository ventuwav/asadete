...
export default function BottomNav({
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-surfaceHighest px-2 pt-2 pb-[max(0.75rem,env(safe-area-inset-bottom,0.75rem))] shadow-[0_-10px_40px_rgba(45,51,53,0.03)] flex justify-between items-center z-50 rounded-t-hero">
