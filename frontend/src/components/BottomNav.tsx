...
export default function BottomNav({
  ...
  const itemClass = (tab: NavTab) =>
    `flex flex-col items-center gap-1 min-w-[44px] min-h-[44px] px-3 py-2 rounded-2xl transition-colors ${
      activeTab === tab
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-surfaceHighest p-2 px-3 shadow-[0_-10px_40px_rgba(45,51,53,0.03)] flex justify-between items-center z-50 rounded-t-hero pb-[max(0.5rem,env(safe-area-inset-bottom,0.5rem))]">
